...
Optimized for 1x H200 GPU (140GB VRAM)
"""
...
# Training Hyperparameters (single H200; keep effective global batch ~64)
...
USE_DEEPSPEED = True  # Enable DeepSpeed ZeRO-3 with CPU offload for single-GPU
...
def create_deepspeed_config():
    """Create DeepSpeed ZeRO-3 configuration for single-GPU training with CPU offload."""
